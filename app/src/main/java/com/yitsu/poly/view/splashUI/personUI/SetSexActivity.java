...
public class SetSexActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editSetSex = (EditText)findViewById(R.id.edit_set_sex);
        ...
        editSetSex.setText(userInfo.getSex());
    }

    /*
    设置性别
     */
    public void setSexSure(View view){
        ...
        String newSex = editSetSex.getText().toString();
        Call<UserInfo> call = Poly.service.setUserInfo(Poly.infoPreference.getInt(ConstantString.USER_ID,0),null,newSex,null,null,null,null,null,null);
