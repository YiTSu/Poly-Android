...
public class SelectAttendedAcsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_attended_acs);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra(ConstantString.IS_LOVED,true);
                intent.putExtra(ConstantString.IS_SHOW_OR_EXIT,ConstantString.SHOW);
                intent.setClass(SelectAttendedAcsActivity.this,ShowAcsActivity.class);
        ...
        listener = new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        Call<ActivityInfo> call = Poly.service.selectAttendedAcs(userId);
                        call.enqueue(new Callback<ActivityInfo>() {
                            ...
                            public void onResponse(Call<ActivityInfo> call, Response<ActivityInfo> response) {
                                ...
                                switch (code){
                                    ...
                                    case 431:
                                        Toast.makeText(getApplicationContext(), R.string.not_attended_acs,Toast.LENGTH_SHORT).show(); break;
                                    case 432:
                                        acts = response.body().getActs();
                                        adapter= new CardsAdapter(SelectAttendedAcsActivity.this,R.layout.listview_item, acts);
